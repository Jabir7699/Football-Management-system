...
<body style="background: url('includes/img/stadium111.jpg') no-repeat;background-size:cover;">
	...
	<div style="text-align:center;">
		...
		<div class="outer" >
			<div class="marqueeBox" style="background: #7986cb">
				...
				<marquee scrollamount="8" direction="down" onmouseover="javascript:this.stop()" onmouseout="javascript:this.start()"
