...
<body style="background: #8c9eff;color: #333">
	...
	<div>
		...
		<table>
			<tr>
			<th></th><th>Player Name</th><th>Position</th><th>Age</th><th>State</th>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_1"></td><td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_2"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_3"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_4"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_5"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_6"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_7"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_8"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_9"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_10"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_11"></td><td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_12"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_13"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_14"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_15"></td>
			</tr>
			<tr>
			...
			</td><td><input type="text" name="state_16"></td>
			</tr>
			...
			</td><td><input type="text" name="state_17"></td>>
			</tr>
			...
			</td><td><input type="text" name="state_18"></td>
			</tr>
		</table>
